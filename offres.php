...
require_once "basededonnee.php"; // On se connecte a la bdd 
	...
	/*$req = $bdd->prepare('SELECT * FROM offre_stage1 ORDER BY id DESC ');
	$req->execute(); */
...
?><div id="recherche_par_ville">
				<div id="contenu_recherche_par_ville">
					...
					<div class="item-list"><h3>Régions actives</h3><ul id="homepage-regions" class="vid_7-list">
...
<?php } $req->closeCursor(); ?>
	<li class="last"><a href="accueil">Toutes les régions</a></li>
			...
			<form method="post">
			 ...
			 <span class="titre">Les offres :</span>
			...
			<div id="inscription">
				...
				<center><a href="inscription">Inscription</a></center>
			</div>
			<?php } ?>